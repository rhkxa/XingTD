...
public class WheelCurvedPicker extends WheelCrossPicker {
    private static final HashMap<Integer, Integer> SPACE = new HashMap<Integer, Integer>();
    private static final HashMap<Integer, Integer> DEPTH = new HashMap<Integer, Integer>();
